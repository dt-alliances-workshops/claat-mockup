...
## Lab 5 - Modernization Review on VM
...
## Step 1 - Get the Public IP to the frontend of the Sample Application.
...
## Step 2- Review Application Service Flow 
...
## Step 3 - Analyze Service Backtrace
