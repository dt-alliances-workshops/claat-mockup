...
The sample application is called Dynatrace Orders.  A more detailed overview can be found here - [https://github.com/dt-orders/overview](https://github.com/dt-orders/overview).  All the source code can be found here - [https://github.com/dt-orders](https://github.com/dt-orders)

### Tasks to complete this step
<details>
<summary>Task 1 - Get the Public IP to the frontend of the Sample Application</summary>

1. Open up Azure console and open up the Virtual Machine page.  You can use the search feature as shown below.
![image](img/lab1-azure-find-vm.png)

2. Once on the Virtual Machine page, click on the VM named `dt-orders-monolith`.  You can explore details about this VM, but you will want to copy the public IP as shown below.
![image](img/lab1-azure-get-public-ip.png)
</details>
<details>

<summary>Task 2 - Navigate the Sample app in a Browser</summary>

1. To view the application, copy the public IP into a browser. It will look like this:
![image](img/lab1-app.png)

2. Use the menu on the home page to navigate around the application and notice the URL for key functionality.  You will see these URLs later as we analyze the application.
...
<details>
<summary>Task - Review the Data on the Hosts screen </summary>
...
<details>
<summary>Task 1 - Review the data on the Process screen </summary>
...
<details>
<summary>Task 2 - Review the data on the Services screen </summary>
...
1. In the management zone drop down, choose `dt-orders-monolith`.
 
 ![image](img/lab1-pick-monolith-mz.png)

2. The filtered list should now look like this:

 ![image](img/lab1-trans-services.png)

3. Choose the `frontend` service.

4. On the `frontend` service page, find the `Dynamic Web Requests` section on the right and click the `view Dynamic Requests` button to see what it calls. 
...
<details><summary>Task 2 - Review the Analysis View screen</summary>
...
### Tasks to complete this step
<details>
<summary>Task - Review the Service Flow </summary>
...
### Tasks to complete this step
<details>
<summary>Task - Review the Service Backtrace </summary>
...
### Tasks to complete this step
<details>
<summary>Task 1 - Navigate to the Database screen </summary>

1. Lets get back to the `backend` service. One way is to go back to the `Services` left side Dynatrace menu and then pick the `backend` service for the `dt-orders-monolith` management zone.
...
<details>
<summary>Task 2 - Review the Database screen </summary>
...
### Tasks to complete this step
<details>
<summary>Task 1 - Review the Technologies view </summary>

1. Click on the **Technology and processes** link on the left side menu within Dynatrace to view the technologies that OneAgent was able to automatically discover and instrument.

    ![image](img/lab1-technology.png)

1. Make sure your management zone filter is set to `All` so that you see everything
